    ...
    <DerivatesMadeSimpleIn3EasParentRoot>
      ...
      <FrameParent>
        <AccountRegistrationSection
          groupLabel="/group-626793.svg"
          groupIdentifier="/group-1000003801.svg"
          actionButtonText="Create an Account"
          registrationSubtitle={`Register & Complete your Verification in less than 2 minutes`}
        />
        <FrameChild alt="" src="/vector-5.svg" />
        <AccountRegistrationSection
          groupLabel="/group-626794.svg"
          groupIdentifier="/group-626789.svg"
          actionButtonText="Deposit Funds"
          registrationSubtitle="Add funds quickly using a variety of payment methods"
          propWidth="1446px"
          propWidth1="107.11px"
          propHeight="100px"
        />
        ...
        <AccountRegistrationSection
          groupLabel="/group-6267941.svg"
          groupIdentifier="/group-1000003802.svg"
          actionButtonText="Become a Trader"
          registrationSubtitle={`Choose Your Trading Pair & Trade Seamlessly`}
          propWidth="1442px"
          propWidth1="115.81px"
          propHeight="120px"
        />
